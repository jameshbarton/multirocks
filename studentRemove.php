...
$queryStr = sprintf("DELETE from student where sid=%d", $sid);
if ($db->query($queryStr)) {
  printf("You successfully removed the student<br>");
}
...
<p>
<a href="teacherHome.php">Return to Teacher Home</a><!-- InstanceEndEditable --></div>
</div>
