...
<div id="middle">
  ...
  <form action="createTeacherResult.php" method="post">
    <h1>Register New Teacher</h1>
    <p><span class="bodytext">Email Address:</span><span class="BlackText">llllllll</span> <span class="bodytext">
      <input type="text" name="email" />
      <br />
      <br/>
        Password:</span><span class="BlackText">llllllllllllllllll</span><span class="bodytext">
  <input type="password" name="password" />
        <br />
        <br/>
        First Name:</span><span class="BlackText">llllllllllllllll</span><span class="bodytext">
  <input type="text" name="firstName" />
        <br />
        <br/>
        Last Name:</span><span class="BlackText">llllllllllllllll</span><span class="bodytext">
  <input type="text" name="lastName" />
        <br />
        <br/>
        Phone Number:</span><span class="BlackText">lllllll</span><span class="bodytext">
  <input type="text" name="phoneNumber" />
        <br />
        <br/>
        School:</span><span class="BlackText">llllllllllllllllllllllll</span>
