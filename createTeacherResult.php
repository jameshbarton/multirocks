...
$queryStr = sprintf("INSERT into teacher (email, password, firstName, lastName, phoneNumber, school) VALUES ('%s','%s','%s','%s','%s','%s')", $email, $password, $firstName, $lastName, $phoneNumber, $school);

if ($db->query($queryStr)) {
  printf("Congratulations! You are registered with email address %s.\n", $email);
}
...
<p>
<a href="teacherLogin.php">Login to Multiplication Rocks!</a>
<p>
<br />
<br />
<br />
