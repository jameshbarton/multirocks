...
<title>MultiplicationRocks Student Login</title>
<!-- InstanceEndEditable -->
...
<h1>Student Login</h1>
<form action="studentHome.php" name="loginForm" method="post">
  <p>Username:<span class="BlackText">lll</span>
  <input type="text" name="username" />
    <br />
    <br/>
    Password:<span class="BlackText">llll</span>
